...
<body>
    ...
    <div style="width:100%;">
        <table
            style="width:1200px;  text-align:center;  margin:auto; margin-top:30px; height:900px; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
            <tr>
                <th colspan="6" style="color:#00415a; border:none;">
                    <h2><u>Transfer Money</u></h2>
                </th>
            </tr>
            <tr
                style="color:white; height:50px; border: 1px solid #00415a; border-collapse: collapse; background-image: linear-gradient(to right, #00415a, #00B8FF);">
                <th>Customer ID</th>
                <th>Customer Name</th>
                <th>Email ID</th>
            ...
            <tr style="background-color:khaki">
                ...
                <td>
                    <form action="./trans.php" method='POST'>
                        ...
                        <button type="submit" style="background-color:red;">Transfer</button>
                    </form>
                </td>
            </tr>
            <?php
